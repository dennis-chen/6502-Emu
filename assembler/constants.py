...
instructionLengths = {
        'ADC': {'INDY': 2, 'IMM': 2, 'INDX': 2, 'ZPX': 2, 'ABS': 3, 'ABSY': 3, 'ZP': 2, 'ABSX': 3},
        'AND': {'INDY': 2, 'IMM': 2, 'INDX': 2, 'ZPX': 2, 'ABS': 3, 'ABSY': 3, 'ZP': 2, 'ABSX': 3},
        'ASL': {'SNGL': 1, 'ZPX': 2, 'ABS': 3, 'ZP': 2, 'ABSX': 3},
        'BCC': {'BRA': 2},
        'BCS': {'BRA': 2},
        'BEQ': {'BRA': 2},
        'BIT': {'ABS': 3, 'ZP': 2},
        ...
        'CLI': {'SNGL': 1},
        'CLV': {'SNGL': 1},
        'CMP': {'INDY': 2, 'IMM': 2, 'INDX': 2, 'ZPX': 2, 'ABS': 3, 'ABSY': 3, 'ZP': 2, 'ABSX': 3},
        'CPX': {'IMM': 2, 'ABS': 3, 'ZP': 2},
        'CPY': {'IMM': 2, 'ABS': 3, 'ZP': 2},
        'DEC': {'ZPX': 2, 'ABS': 3, 'ZP': 2, 'ABSX': 3},
        'DEX': {'SNGL': 1},
        'DEY': {'SNGL': 1},
        'EOR': {'INDY': 2, 'IMM': 2, 'INDX': 2, 'ZPX': 2, 'ABS': 3, 'ABSY': 3, 'ZP': 2, 'ABSX': 3},
        'INC': {'ZPX': 2, 'ABS': 3, 'ZP': 2, 'ABSX': 3},
        'INX': {'SNGL': 1},
        'INY': {'SNGL': 1},
        'JMP': {'ABS': 3, 'IND': 3},
        'JSR': {'ABS': 3},
        'LDA': {'INDY': 2, 'IMM': 2, 'INDX': 2, 'ZPX': 2, 'ABS': 3, 'ABSY': 3, 'ZP': 2, 'ABSX': 3},
        'LDX': {'IMM': 2, 'ABS': 3, 'ABSY': 3, 'ZPY': 2, 'ZP': 2},
        'LDY': {'IMM': 2, 'ZPX': 2, 'ABS': 3, 'ZP': 2, 'ABSX': 3},
        'LSR': {'SNGL': 1, 'ZPX': 2, 'ABS': 3, 'ZP': 2, 'ABSX': 3},
        'NOP': {'SNGL': 1},
        'ORA': {'INDY': 2, 'IMM': 2, 'INDX': 2, 'ZPX': 2, 'ABS': 3, 'ABSY': 3, 'ZP': 2, 'ABSX': 3},
        'PHA': {'SNGL': 1},
        'PHP': {'SNGL': 1},
        'PLA': {'SNGL': 1},
        'PLP': {'SNGL': 1},
        'ROL': {'SNGL': 1, 'ZPX': 2, 'ABS': 3, 'ZP': 2, 'ABSX': 3},
        'ROR': {'SNGL': 1, 'ZPX': 2, 'ABS': 3, 'ZP': 2, 'ABSX': 3},
        'RTI': {'SNGL': 1},
        'RTS': {'SNGL': 1},
        'SBC': {'INDY': 2, 'IMM': 2, 'INDX': 2, 'ZPX': 2, 'ABS': 3, 'ABSY': 3, 'ZP': 2, 'ABSX': 3},
        'SEC': {'SNGL': 1},
        'SED': {'SNGL': 1},
        'SEI': {'SNGL': 1},
        'STA': {'INDY': 2, 'INDX': 2, 'ZPX': 2, 'ABS': 3, 'ABSY': 3, 'ZP': 2, 'ABSX': 3},
        'STX': {'ABS': 3, 'ZPY': 2, 'ZP': 2},
        'STY': {'ZPX': 2, 'ABS': 3, 'ZP': 2},
        'TAX': {'SNGL': 1},
        'TAY': {'SNGL': 1},
        'TSX': {'SNGL': 1},
        'TXA': {'SNGL': 1},
